...
class Scraping:
    ...
    def scrapingImages(self,url):
        ...
        try:
            ...
            for image in images:
                ...
                #Mover a carpeta Unica
                Ruta = os.getcwd() + '\WebScraping'
                IM = os.getcwd() + "\images"
                if os.path.isdir(IM):
                    r = shutil.move(IM, Ruta + "\images")
    ...
    def scrapingLinks(self,url):
            ...
            try:
                ...
                #Mover a carpeta Unica
                Ruta = os.getcwd() + '\WebScraping'
                LI = os.getcwd() + "\Links.txt"
                if os.path.isfile("Links.txt"):
                    r = shutil.move(LI, Ruta + "\Links.txt")
